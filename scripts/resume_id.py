...
story.append(Paragraph('[Nama Perusahaan Saat Ini] &nbsp;|&nbsp; [Tahun Mulai] - Sekarang &nbsp;|&nbsp; [Kota], Indonesia', job_meta_style))
...
projects_id = [
    ...
    ('PathMentor AI - Adaptive AI Tutor untuk Siswa SMA (Gemini XPRIZE 2026)',
